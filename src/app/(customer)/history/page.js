      ...
      <section className="flex-col p-6 lg:p-12 bg-studio-50 min-h-[calc(100vh-72px)] flex items-center justify-start">
          <div className="max-w-6xl w-full pt-8 pb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {history.map((item) => (
                  <div key={item.id} id={`ticket-${item.id}`} className="bg-white border border-studio-900 rounded-sm relative shadow-sm">
                      {/* Ticket Header */}
                      <div className="p-6 border-b border-dashed border-studio-300 relative">
                          <div className="absolute -left-3 -bottom-3 w-6 h-6 bg-studio-50 rounded-full border-r border-studio-900"></div>
                          <div className="absolute -right-3 -bottom-3 w-6 h-6 bg-studio-50 rounded-full border-l border-studio-900"></div>
                      ...
                      <div className="p-6 space-y-6">
                          ...
                          {/* Barcode Mock */}
                          <div className="pt-4 flex flex-col items-center justify-center border-t border-studio-900">
              ...
              {history.length === 0 && (
                <div className="text-center p-8 bg-white border border-studio-900 mt-8">

    ...
    return (
      <>
        ...
        <section className="flex-col p-6 lg:p-12 bg-white min-h-[calc(100vh-72px)] flex items-center justify-center">
            <div className="max-w-md w-full bg-studio-50 p-12 text-center border border-studio-900 rounded-sm">
    ...
    <>
      ...
      <section className="flex-col p-6 lg:p-12 bg-white min-h-[calc(100vh-72px)]">
          <div className="max-w-2xl mx-auto w-full space-y-8 pt-8">
              <div className="border-b border-studio-900 pb-6 text-center">
              ...
              <div className="bg-studio-50 p-8 border border-studio-900 rounded-sm space-y-6">
                  ...
                  <div className="text-center pt-6 border-t border-studio-900">
              ...
              <div className="space-y-4 pt-4">
                  ...
                  <label htmlFor="file-upload" className="flex flex-col items-center justify-center w-full h-40 border-2 border-studio-900 border-dashed rounded-sm cursor-pointer bg-studio-50 hover:bg-studio-100 transition">

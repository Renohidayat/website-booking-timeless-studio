export default function AdminSchedulesPage() {
  return (
    <div className="space-y-8">
      ...
      <div className="mt-4 bg-blue-50 border border-blue-200 rounded-xl p-8 text-center max-w-2xl mx-auto">
        <div className="mx-auto w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4">
           <i className="fa-solid fa-robot text-2xl text-blue-600"></i>
        </div>
        <h2 className="text-xl font-bold text-blue-900 mb-2">Sistem Jadwal Otomatis Aktif</h2>

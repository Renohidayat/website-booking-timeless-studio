  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-950 text-white">
      ...
      <nav className="flex items-center justify-between p-6 md:px-12 lg:px-24">
        <h1 className="text-xl font-bold tracking-widest text-indigo-400 uppercase">Timeless</h1>
        <div className="space-x-6">
          <Link href="/login" className="text-sm font-medium hover:text-indigo-400 transition-colors">Login</Link>
          <Link href="/register" className="text-sm font-medium rounded-full bg-indigo-600 px-5 py-2 hover:bg-indigo-500 transition-all">Daftar</Link>
        </div>
      </nav>
